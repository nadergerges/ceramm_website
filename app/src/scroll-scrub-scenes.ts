...
export const scrollScrubScenes: ScrollScrubScene[] = [
  {
    ...
    title: "Every piece begins as earth",
  },
  {
    align: "right",
    body: "Wheel thrown in Faenza, press molded in Manises, carved in Provence, painted in Iznik.",
    ...
    scroll: 1.4,
    title: "Thrown by hands, held for generations",
  },
  {
    align: "left",
    body: "At 1260 degrees the clay vitrifies. What leaves the kiln will outlive us all.",
